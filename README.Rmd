...
We build the CLI and the library, provide a CLI wrapper. CLI is used for creating, ingesting, exporting, and querying TileDB-VCF datasets and library will be used for future R bindings. This is a work in progress.
